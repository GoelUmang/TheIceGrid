...
const ethereum = window.ethereum; // Ethereum window object
...
export const TransactionProvider = ({ children }) => {
    ...
    try {
      if (ethereum) {
        ...
        const structuredTransactions = availableTransactions.map((transaction) => ({
          ...
          amount: parseInt(transaction.amount._hex) / (10 ** 18) //GWEI to Eth
        }));
  ...
  const sendTransaction = async () => {
    try {
      if (!ethereum) return alert("Ethereum object not found. Please install MetaMask.");
...
// const { ethereum } = window; //etherium window object
...
//---------_-____--__--___-__--___-___-_--____---_____---------------______________________--------------------------------_____------_______---___--___


// export const TransactiosnProvider = ({ children }) => {
//   const [formData, setformData] = useState({ addressTo: "", amount: "", keyword: "", message: "" });
//   const [currentAccount, setCurrentAccount] = useState("");
//   const [isLoading, setIsLoading] = useState(false);
//   const [transactionCount, setTransactionCount] = useState(localStorage.getItem("transactionCount"));
